...
export default function LongTermForm({ onSubmit }: LongTermFormProps) {
  ...
  const renderCalendar = () => {
    ...
    for (let day = 1; day <= daysInMonth; day++) {
      ...
      let btnClass = 'text-gray-800 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-white/5 rounded-full';
      if (isPast) {
  ...
  return (
    ...
    >
      ...
      <div 
        ref={datePickerRef} 
        className="relative flex-1 flex items-center gap-3 px-6 py-3 cursor-pointer select-none border-t md:border-t-0 md:border-l border-gray-100 dark:border-white/5"
      >
        <div 
        ...
        {isDatePickerOpen && (
          <div className="absolute left-0 top-[102%] w-[280px] bg-white text-gray-900 border border-gray-100 rounded-2xl shadow-2xl z-30 p-4 animate-slide-up-custom">
            ...
            <div className="grid grid-cols-7 text-center text-[10px] font-bold text-gray-400 py-1 mb-1">
      ...
      >
        ...
        {isDurationOpen && (
          <div className="absolute left-0 top-[102%] w-full min-w-[180px] bg-white border border-gray-100 rounded-xl shadow-xl z-30 py-2 animate-slide-up-custom">
